...
Best approach-use 2 pointer approach but store the character with its last occurance index so whenever there is a duplicate you move 
the left to the last occurance of repeating char +1 and update its new occurance as its new index 
*/
